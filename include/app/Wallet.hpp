...
public:
  ...
  [[nodiscard]] std::optional<crypto::str> balance(const RpcConfiguration& rpc_config) const;
  [[nodiscard]] std::optional<crypto::str> height(const RpcConfiguration& rpc_config) const;
  [[nodiscard]] std::optional<crypto::str> peers(const RpcConfiguration& rpc_config) const;
