...
TEST(BlockDeserialize, RoundTripPreservesTransactions) {
    ...
    txs.emplace_back("alice", "bob", 100, forgechain::crypto::bytes{}, 0, 0);
    txs.emplace_back("bob", "carol", 50, forgechain::crypto::bytes{}, 0, 0);
    txs.emplace_back("carol", "alice", 25, forgechain::crypto::bytes{}, 0, 0);
...
TEST(BlockDeserialize, RoundTripPreservesHashExactly) {
    std::vector<Transaction> txs;
    txs.emplace_back("miner", "reward_pool", 5000000, forgechain::crypto::bytes{}, 0, 0);
