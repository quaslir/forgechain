...
TEST(Blockchain, ClassifyNewBlockAcceptsCoinbaseFollowedByRegularTransactions) {
    Blockchain chain;
    Transaction coinbase(kCoinbaseSender, "alice", 50, {}, 0, 0);
    Transaction regular("alice", "bob", 10, {}, 0, 0);
...
TEST(Blockchain, ClassifyNewBlockRejectsCoinbaseAsSecondTransaction) {
    Blockchain chain;
    Transaction regular("alice", "bob", 10, {}, 0, 0);
    Transaction coinbase(kCoinbaseSender, "mallory", 50, {}, 0, 0);
...
TEST(Blockchain, ClassifyNewBlockRejectsTwoCoinbaseTransactions) {
    Blockchain chain;
    Transaction coinbase1(kCoinbaseSender, "alice", 50, {}, 0, 0);
    Transaction coinbase2(kCoinbaseSender, "mallory", 50, {}, 0, 0);
...
TEST(Blockchain, ClassifyNewBlockWithNoCoinbaseIsUnaffectedByCoinbaseCheck) {
    Blockchain chain;
    Transaction regular1("alice", "bob", 10, {}, 0, 0);
    Transaction regular2("bob", "charlie", 5, {}, 0, 0);
